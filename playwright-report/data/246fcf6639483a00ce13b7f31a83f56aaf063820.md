...
- Name: e2e/topology-user-flows.spec.js >> End-to-End User Flows >> Flow 1: Inspect details, clear selection, and hover
- Location: tests/e2e/topology-user-flows.spec.js:10:7
