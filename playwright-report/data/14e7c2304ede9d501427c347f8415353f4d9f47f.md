...
- Name: e2e/topology-interaction.spec.js >> Topology Interactions >> clicking a bridge opens InfoPanel
- Location: tests/e2e/topology-interaction.spec.js:60:7
...
Call log:
  ...
  - waiting for locator('text="BRIDGE"')
...
- button "+"
- button "APPLY"
- text: "ELEMENTS: 227 BRIDGE: bridge-0-0-0"
- button "+"
- button "−"
- button "⊡"
- button "↺"
- text: "ZOOM: 74% FROM → ← TO ↔ BOTH bridge"
- button "Close": ×
- text: id bridge-0-0-0 label V routerId router-0-0 x 200 y 52 radius 18 index 0 parent router-0-0
- alert
```
