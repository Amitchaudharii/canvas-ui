...
- Name: visual/topology-visual.spec.js >> Visual Regression >> zoomed in view @visual
- Location: tests/visual/topology-visual.spec.js:47:7

# Error details

```
Error: A snapshot doesn't exist at /Users/jayantchaudhary/Documents/canvas-ui/tests/visual/screenshots/visual/topology-visual.spec.js-snapshots/topology-zoomed-in-chromium-darwin.png, writing actual.
```
