...
- Name: visual/topology-visual.spec.js >> Visual Regression >> router hover state @visual
- Location: tests/visual/topology-visual.spec.js:25:7

# Error details

```
Error: A snapshot doesn't exist at /Users/jayantchaudhary/Documents/canvas-ui/tests/visual/screenshots/visual/topology-visual.spec.js-snapshots/topology-router-hover-chromium-darwin.png, writing actual.
```
