...
- Name: visual/topology-visual.spec.js >> Visual Regression >> custom styled elements via API @visual
- Location: tests/visual/topology-visual.spec.js:60:7

# Error details

```
Error: A snapshot doesn't exist at /Users/jayantchaudhary/Documents/canvas-ui/tests/visual/screenshots/visual/topology-visual.spec.js-snapshots/topology-custom-styled-chromium-darwin.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e5]:
    - generic [ref=e6]:
      - generic [ref=e7]: router
      - button "Close" [ref=e8] [cursor=pointer]: ×
    - generic [ref=e9]:
      - generic [ref=e10]:
        - generic [ref=e11]: id
        - generic "router-1-1" [ref=e12]
      - generic [ref=e13]:
